                ...
                <div className="row">
                    <div className="col-lg-5" data-aos="fade-up">
                        ...
                        <div className="info groom-info">
                            <h3>Hafiz Gadwal Mohammed Sufiyan Umri Naziri</h3>
                            ...
                            <p className="mt-1 mt-lg-2">
                                S/O Janab{" "}
                                <strong>Gadwal Allabakash Sahab,</strong>
                            </p>
                            ...
                            <p className="mt-1 mt-lg-2">
                                Retired Bill Collector Municipality.
                            </p>
                    ...
                    <div className="col-lg-5" data-aos="fade-up">
                        ...
                        <div className="info bride-info">
                            <h3>
                                Gadwal Sabiha Hasanati<sub>(Aalima),</sub>
                            </h3>
                            {/* <p className="mt-2 mt-lg-3">
